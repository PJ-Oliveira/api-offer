...
class OfferServiceTest {
    ...
    @Test
    void testDisableOffer_WhenDisableOfferByIdProduct_ExpectedSuccess() {
        doNothing().when(this.offerRepository).disableOfferByIdProduct((Long) any());
        this.offerService.disableOffer(new DeleteOfferDto());
        verify(this.offerRepository).disableOfferByIdProduct((Long) any());
    }
